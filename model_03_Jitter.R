...
run_esc<-paste0(getwd(),"/model/run/S0") 
jitter_esc<-paste0(getwd(),"/model/jitter/S0")
...
file.copy(paste(dirname.base,       "ss3", sep="/"),
          paste(dirname.jitter,     "ss3", sep="/"))
...
jit.likes <- jitter(mydir=dirname.jitter, Njitter=Njitter, extras="")
